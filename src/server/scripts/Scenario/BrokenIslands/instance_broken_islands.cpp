...
struct instance_broken_islands : public InstanceScript
{
    instance_broken_islands(Map* map) : InstanceScript(map) {}
...
{
    RegisterInstanceScript(instance_broken_islands, 1460);
}