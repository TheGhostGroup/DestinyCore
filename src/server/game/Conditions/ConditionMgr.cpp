...
bool ConditionMgr::isConditionTypeValid(Condition* cond)
{
    ...
    switch (cond->ConditionType)
    {
        ...
        case CONDITION_QUESTSTATE:
            ...
            {
                TC_LOG_ERROR("sql.sql", "Invalid state mask (%u), skipped.", cond->ConditionValue2);
                return false;
            }
            /* fallthrough */
        case CONDITION_QUESTREWARDED:
        ...
        case CONDITION_OBJECT_ENTRY_GUID:
        {
            switch (cond->ConditionValue1)
            {
                case TYPEID_UNIT:
                {
                    ...
                    {
                        TC_LOG_ERROR("sql.sql", "Non-existing creature template entry (%u), skipped.", cond->ConditionValue2);
                        return false;
                    }
                    if (cond->ConditionValue3)
                    {
                        if (CreatureData const* creatureData = sObjectMgr->GetCreatureData(cond->ConditionValue3))
                        {
                            ...
                            {
                                TC_LOG_ERROR("sql.sql", "Guid %u set but does not match creature entry (%u), skipped.", cond->ConditionValue3, cond->ConditionValue2);
                                return false;
                            }
                        }
                        else
                        {
                            TC_LOG_ERROR("sql.sql", "Non-existing creature guid (%u), skipped.", cond->ConditionValue3);
                            return false;
                        }
                    }
                    break;
                ...
                case TYPEID_GAMEOBJECT:
                {
                    ...
                    {
                        TC_LOG_ERROR("sql.sql", "Non-existing gameobject template entry (%u), skipped.", cond->ConditionValue2);
                        return false;
                    }
                    if (cond->ConditionValue3)
                    {
                        if (GameObjectData const* goData = sObjectMgr->GetGOData(cond->ConditionValue3))
                        {
                            ...
                            {
                                TC_LOG_ERROR("sql.sql", "Guid %u set but does not match gameobject entry (%u), skipped.", cond->ConditionValue3, cond->ConditionValue2);
                                return false;
                            }
                        }
                        else
                        {
                            TC_LOG_ERROR("sql.sql", "Non-existing gameobject guid (%u), skipped.", cond->ConditionValue3);
                            return false;
                        }
                    }
                break;
        ...
        case CONDITION_PHASEID:
        {
            ...
            {
                TC_LOG_ERROR("sql.sql", "Non-existent phaseid in value1 (%u), skipped", cond->ConditionValue1);
                return false;
            }
            break;
        }
        ...
        case CONDITION_PET_TYPE:
        {
            ...
            {
                TC_LOG_ERROR("sql.sql", "Non-existing pet type %u, skipped.", cond->ConditionValue1);
                return false;
            }
            break;
        }
        case CONDITION_UNIT_STATE:
        {
            ...
            {
                TC_LOG_ERROR("sql.sql", "Non-existing UnitState in value1 (%u), skipped.", cond->ConditionValue1);
                return false;
            }
            break;
        }
        case CONDITION_CREATURE_TYPE:
        {
            ...
            {
                TC_LOG_ERROR("sql.sql", "Non-existing CreatureType in value1 (%u), skipped.", cond->ConditionValue1);
                return false;
            }
            break;
        }
        case CONDITION_DIFFICULTY_ID:
        {
            ...
            {
                TC_LOG_ERROR("sql.sql", "Non-existing difficulty in value1 (%u), skipped.", cond->ConditionValue1);
                return false;
            }
            break;
        }
