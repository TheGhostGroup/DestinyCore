...
void World::SetInitialWorldSettings()
{
    ...
    TC_LOG_INFO("server.loading", "---INITIALIZE ANTICHEAT SYSTEM---");
    TC_LOG_INFO("server.loading", "Load anticheat data...");
    ...
    TC_LOG_INFO("server.loading", "Loading LoadSpellCustomAttr Data...");
    ...
    TC_LOG_INFO("server.loading", "Loading AreaTriggerForces...");
    ...
    TC_LOG_INFO("server.loading", "Loading ConversationData...");
    ...
    TC_LOG_INFO("server.loading", "Loading WDB Creature template...");
    sObjectMgr->LoadWDBCreatureTemplates();

    TC_LOG_INFO("server.loading", "Loading Creature template...");
    sObjectMgr->LoadCreatureTemplates();

    TC_LOG_INFO("server.loading", "Loading EventObject Template...");
    ...
    TC_LOG_INFO("server.loading", "Loading Points Of Interest...");
    ...
    TC_LOG_INFO("server.loading", "Loading EventObjects...");
    sEventObjectDataStore->LoadEventObjects();

    TC_LOG_INFO("server.loading", "Loading Conversations Data...");
    ...
    TC_LOG_INFO("server.loading", "Loading Quest Data...");
    ...
    TC_LOG_INFO("server.loading", "Loading Quest POI Data...");
    sQuestDataStore->LoadQuestPOI();

    TC_LOG_INFO("server.loading", "Loading QuestRelations Data...");
    ...
    TC_LOG_INFO("server.loading", "Initialize sWorldStateMgr...");
    sWorldStateMgr.Initialize();
    TC_LOG_INFO("server.loading", "Initialize sContributionMgr...");
    sContributionMgr.Initialize();

    TC_LOG_INFO("server.loading", "Initialize WorldQuest Hourly Reset Time...");
    InitWorldQuestHourlyResetTime();
    TC_LOG_INFO("server.loading", "Initialize Init WorldQuest Daily Reset Time...");
    InitWorldQuestDailyResetTime();
    TC_LOG_INFO("server.loading", "Initialize Invasion Point Reset Time...");
    InitInvasionPointResetTime();
    TC_LOG_INFO("server.loading", "Loading WorldQuest Templates...");
    ...
    TC_LOG_INFO("server.loading", "Loading AreaTrigger Teleports...");
    ...
    TC_LOG_INFO("server.loading", "Loading Quest AreaTriggers...");
    sAreaTriggerDataStore->LoadQuestAreaTriggers();     // must be after LoadQuests
    TC_LOG_INFO("server.loading", "Loading Tavern AreaTriggers...");
    sAreaTriggerDataStore->LoadTavernAreaTriggers();
    TC_LOG_INFO("server.loading", "Loading AreaTrigger Actions And Data...");
    sAreaTriggerDataStore->LoadAreaTriggerActionsAndData();
    TC_LOG_INFO("server.loading", "Loading AreaTrigger Scripts...");
    ...
    TC_LOG_INFO("server.loading", "Loading Talent Spell Linked...");
    sSpellMgr->LoadTalentSpellLinked();
    TC_LOG_INFO("server.loading", "Loading Spell Concatenate Aura...");
    ...
    TC_LOG_INFO("server.loading", "Loading Spell Visual...");
    sSpellMgr->LoadSpellVisual();
    TC_LOG_INFO("server.loading", "Loading Spell Pending Cast...");
    sSpellMgr->LoadSpellPendingCast();
    TC_LOG_INFO("server.loading", "Loading Spell Scene...");
    ...
    TC_LOG_INFO("server.loading", "Execute Character Database Cleaner...");
    ...
    TC_LOG_INFO("server.loading", "Loading Guild Challenge Reward Info...");
    sGuildMgr->LoadGuildChallengeRewardInfo();

    TC_LOG_INFO("server.loading", "Loading Guilds...");
    sGuildMgr->LoadGuilds();

    TC_LOG_INFO("server.loading", "Execute sGuildFinderMgr->LoadFromDB...");
    sGuildFinderMgr->LoadFromDB();

    TC_LOG_INFO("server.loading", "Loading Characte rBrackets...");
    sBracketMgr->LoadCharacterBrackets();

    TC_LOG_INFO("server.loading", "Loading Groups...");
    sGroupMgr->LoadGroups();

    TC_LOG_INFO("server.loading", "Loading Reserved Players Names...");
    ...
    TC_LOG_INFO("server.loading", "Loading Pvp Rewards...");
    ...
    TC_LOG_INFO("server.loading", "Execute m_timers[WUPDATE_DONATE_AND_SERVICES].SetInterval( 3 * HOUR * IN_MILLISECONDS);...");
    ...
    TC_LOG_INFO("server.loading", "Loading Faction Change Achievements...");
    ...
    TC_LOG_INFO("server.loading", "Loading Faction Change Reputations...");
    ...
    TC_LOG_INFO("server.loading", "Execute Validate Spell Scripts...");
    ...
    TC_LOG_INFO("server.loading", "Execute Delete Old Characters...");
    ...
    TC_LOG_INFO("server.loading", "Initialize Ticket system...");
    ...
    TC_LOG_INFO("server.loading", "Initialize Brawl Data...");
	...
	TC_LOG_INFO("server.loading", "Loading Custom Pvp Penalizations...");
                ...
                while (countitems && itemid)
                {
                    ...
                    if(attachment != nullptr)
                    {
                        ...
                        if(store_history)
                        {
                            ...
                            LoginDatabasePreparedStatement* stmt2 = LoginDatabase.GetPreparedStatement(LOGIN_UPD_HISTORY_GUID);
                            stmt2->setUInt64(0, attachment->GetGUIDLow());
                            stmt2->setUInt32(1, store_history);
                            stmt2->setUInt32(2, itemid);
                            transs->Append(stmt2);
...
void World::LoadCustomPvpPenalizations()
{
	...
	if (!result)
	{
		TC_LOG_INFO("server.loading", ">> Loaded 0 custom pvp penalizations. DB table `custom_pvp_penalizations` is empty.");
		return;
	}
	...
	TC_LOG_INFO("server.loading", ">> Loaded %u custom pvp penalization in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
}
